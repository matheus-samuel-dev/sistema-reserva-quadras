...
export function StatCard({
  ...
  return (
    <article className="glass-panel card-hover animate-enter min-w-0 rounded-lg p-4">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <p className="min-h-8 text-xs font-semibold uppercase leading-4 tracking-normal text-muted">{title}</p>
          <strong className="metric-value mt-2 block break-words text-xl font-black leading-tight text-[var(--text)] sm:text-2xl">{value}</strong>
        </div>
